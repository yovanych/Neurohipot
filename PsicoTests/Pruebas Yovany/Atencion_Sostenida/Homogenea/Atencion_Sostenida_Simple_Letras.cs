...
{
    public class Atencion_Sostenida_Simple_Letras : Prueba_Psicológica
    {
        ...
        public Atencion_Sostenida_Simple_Letras( Resultado r, int index, int bloques, int estimulos, int cantidad )
            :base(r)
		{
