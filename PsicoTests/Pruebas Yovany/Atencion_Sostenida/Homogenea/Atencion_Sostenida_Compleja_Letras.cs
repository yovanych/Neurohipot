...
{
    public class Atencion_Sostenida_Compleja_Letras : Prueba_Psicológica
    {
        ...
        public static int PIndexDiana1 = 0;
        public static int PIndexDiana2 = 15;
        public static Color PColorFondo = Color.FromArgb(101, 99, 102);
        public static Color PColorLetras = Color.Yellow;
        ...
        public Atencion_Sostenida_Compleja_Letras( Resultado r, int index, int index1, int bloques, int estimulos, int cantidad)
            : base(r)
        {
