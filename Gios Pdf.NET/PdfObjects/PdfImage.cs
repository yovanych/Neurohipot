...
namespace Gios.Pdf
{
	...
	public class PdfImage : PdfObject
	{
        ...
        internal PdfImage(int id, byte[] img)
        {
            this.id = id;
            this.file = img;
            ...
            try
            {
                //Image imgOriginal = Image.FromStream(ImageStream);
                this.bmp = new Bitmap(ImageStream);
            }
            catch
            {
                throw new Exception("Error cargando imagen del MemoryStream");
            }
        }
        #endregion
        ...
        internal int StreamGifWrite(System.IO.Stream stream)
		{
            ...
            m = new MemoryStream(this.file);
			
            //byte[] data = new byte[fs.Length];
            byte[] data = this.file;
	
            //System.Drawing.Image i = Image.FromFile(file);
            System.Drawing.Image i = Image.FromStream(m);
